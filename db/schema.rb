...
ActiveRecord::Schema.define(version: 20170922212918) do
  ...
  add_index "user_queries", ["query_id"], name: "index_user_queries_on_query_id", using: :btree
  add_index "user_queries", ["user_id"], name: "index_user_queries_on_user_id", using: :btree
